...
export class CreateTables1670505591213 implements MigrationInterface {
    name = 'CreateTables1670505591213'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`planets\` (\`id\` int NOT NULL AUTO_INCREMENT, \`created\` varchar(255) NULL, \`edited\` varchar(255) NULL, \`url\` varchar(255) NULL, \`images\` varchar(255) NOT NULL DEFAULT '', \`name\` varchar(255) NOT NULL DEFAULT 'unknown', \`rotation_period\` varchar(255) NOT NULL DEFAULT 'unknown', \`orbital_period\` varchar(255) NOT NULL DEFAULT 'unknown', \`diameter\` varchar(255) NOT NULL DEFAULT 'unknown', \`climate\` varchar(255) NOT NULL DEFAULT 'unknown', \`gravity\` varchar(255) NOT NULL DEFAULT 'unknown', \`terrain\` varchar(255) NOT NULL DEFAULT 'unknown', \`surface_water\` varchar(255) NOT NULL DEFAULT 'unknown', \`population\` varchar(255) NOT NULL DEFAULT 'unknown', \`residents\` text NOT NULL, \`films\` text NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`species\` (\`id\` int NOT NULL AUTO_INCREMENT, \`created\` varchar(255) NULL, \`edited\` varchar(255) NULL, \`url\` varchar(255) NULL, \`images\` varchar(255) NOT NULL DEFAULT '', \`name\` varchar(255) NOT NULL DEFAULT 'unknown', \`classification\` varchar(255) NOT NULL DEFAULT 'unknown', \`designation\` varchar(255) NOT NULL DEFAULT 'unknown', \`average_height\` varchar(255) NOT NULL DEFAULT 'unknown', \`skin_colors\` varchar(255) NOT NULL DEFAULT 'unknown', \`hair_colors\` varchar(255) NOT NULL DEFAULT 'unknown', \`eye_colors\` varchar(255) NOT NULL DEFAULT 'unknown', \`average_lifespan\` varchar(255) NOT NULL DEFAULT 'unknown', \`homeworld\` varchar(255) NULL, \`language\` varchar(255) NOT NULL, \`people\` text NOT NULL, \`films\` text NOT NULL, \`homeworldRel\` int NULL, UNIQUE INDEX \`REL_651deb429602ad70fd4b8d8050\` (\`homeworldRel\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`starships\` (\`id\` int NOT NULL AUTO_INCREMENT, \`created\` varchar(255) NULL, \`edited\` varchar(255) NULL, \`url\` varchar(255) NULL, \`images\` varchar(255) NOT NULL DEFAULT '', \`name\` varchar(255) NOT NULL DEFAULT 'unknown', \`model\` varchar(255) NOT NULL DEFAULT 'unknown', \`manufacturer\` varchar(255) NOT NULL DEFAULT 'unknown', \`cost_in_credits\` varchar(255) NOT NULL DEFAULT 'unknown', \`length\` varchar(255) NOT NULL DEFAULT 'unknown', \`max_atmosphering_speed\` varchar(255) NOT NULL DEFAULT 'unknown', \`crew\` varchar(255) NOT NULL DEFAULT 'unknown', \`passengers\` varchar(255) NOT NULL DEFAULT 'unknown', \`cargo_capacity\` varchar(255) NOT NULL DEFAULT 'unknown', \`consumables\` varchar(255) NOT NULL DEFAULT 'unknown', \`hyperdrive_rating\` varchar(255) NOT NULL DEFAULT 'unknown', \`MGLT\` varchar(255) NOT NULL DEFAULT 'unknown', \`starship_class\` varchar(255) NOT NULL DEFAULT 'unknown', \`pilots\` text NOT NULL, \`films\` text NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`vehicles\` (\`id\` int NOT NULL AUTO_INCREMENT, \`created\` varchar(255) NULL, \`edited\` varchar(255) NULL, \`url\` varchar(255) NULL, \`images\` varchar(255) NOT NULL DEFAULT '', \`name\` varchar(255) NOT NULL DEFAULT 'unknown', \`model\` varchar(255) NOT NULL DEFAULT 'unknown', \`manufacturer\` varchar(255) NOT NULL DEFAULT 'unknown', \`cost_in_credits\` varchar(255) NOT NULL DEFAULT 'unknown', \`length\` varchar(255) NOT NULL DEFAULT 'unknown', \`max_atmosphering_speed\` varchar(255) NOT NULL DEFAULT 'unknown', \`crew\` varchar(255) NOT NULL DEFAULT 'unknown', \`passengers\` varchar(255) NOT NULL DEFAULT 'unknown', \`cargo_capacity\` varchar(255) NOT NULL DEFAULT 'unknown', \`consumables\` varchar(255) NOT NULL DEFAULT 'unknown', \`vehicle_class\` varchar(255) NOT NULL DEFAULT 'unknown', \`pilots\` text NOT NULL, \`films\` text NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`films\` (\`id\` int NOT NULL AUTO_INCREMENT, \`created\` varchar(255) NULL, \`edited\` varchar(255) NULL, \`url\` varchar(255) NULL, \`images\` varchar(255) NOT NULL DEFAULT '', \`title\` varchar(255) NOT NULL, \`episode_id\` int NOT NULL, \`opening_crawl\` text NOT NULL, \`director\` varchar(255) NOT NULL, \`producer\` varchar(255) NOT NULL, \`release_date\` varchar(255) NOT NULL, \`characters\` text NOT NULL, \`planets\` text NOT NULL, \`starships\` text NOT NULL, \`vehicles\` text NOT NULL, \`species\` text NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
