...
export class RandomMockPlanetGenerator extends RandomMockUnitsGenerator<Planets, CreatePlanetDto> {

    generateOneWithRelatedUnits(): Planets {
        const unit: Planets = this.generateOneWithoutRelatedUnits();
    ...
    transformSingleUnitToCreateDto(planet: Planets): CreatePlanetDto {
    ...
    generateOneWithoutRelatedUnits(): Planets {
