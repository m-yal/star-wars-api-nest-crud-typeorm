...
export class VehiclesService extends SwapiAbstractService<Vehicles> {
    ...
    constructor(@InjectRepository(Vehicles) vehiclesRepository: Repository<Vehicles>, @Inject("IFilesActions") filesService: FilesService) {
        super(vehiclesRepository, filesService);
    }
}