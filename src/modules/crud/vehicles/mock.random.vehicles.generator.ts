...
export class RandomMockVehiclesGenerator extends RandomMockUnitsGenerator<Vehicles, CreateVehicleDto> {

    generateOneWithRelatedUnits(): Vehicles {
        const unit: Vehicles = this.generateOneWithoutRelatedUnits();
    ...
    transformSingleUnitToCreateDto(vehicle: Vehicles): CreateVehicleDto {
    ...
    generateOneWithoutRelatedUnits(): Vehicles {
