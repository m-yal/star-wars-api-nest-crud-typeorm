...
export class PeopleService extends SwapiAbstractService<People> {
    ...
    constructor(@InjectRepository(People) peopleRepository: Repository<People>, @Inject("IFilesActions") filesService: FilesService) {
        super(peopleRepository, filesService);
    }
}