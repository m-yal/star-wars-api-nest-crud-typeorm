...
export class RandomMockStrashipsGenerator extends RandomMockUnitsGenerator<Starship, CreateStarshipDto> {

    generateOneWithRelatedUnits(): Starship {
        const unit: Starship = this.generateOneWithoutRelatedUnits();
    ...
    transformSingleUnitToCreateDto(starship: Starship): CreateStarshipDto {
    ...
    generateOneWithoutRelatedUnits(): Starship {
        return plainToInstance(Starship, {
