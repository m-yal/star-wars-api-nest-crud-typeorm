...
export class RandomMockFilmsGenerator extends RandomMockUnitsGenerator<Film, CreateFilmDto> {

    generateOneWithRelatedUnits(): Film {
        const unit: Film = this.generateOneWithoutRelatedUnits();
    ...
    transformSingleUnitToCreateDto(film: Film): CreateFilmDto {
    ...
    generateOneWithoutRelatedUnits(): Film {
