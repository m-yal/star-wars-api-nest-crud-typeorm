...
export class RandomMockPeopleGenerator extends RandomMockUnitsGenerator<Person, CreatePeopleDto> {

    generateOneWithRelatedUnits(): Person {
        const unit: Person = this.generateOneWithoutRelatedUnits();
    ...
    transformSingleUnitToCreateDto(people: Person): CreatePeopleDto {
    ...
    generateOneWithoutRelatedUnits(): Person {
